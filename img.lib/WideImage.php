 ...
 * @copyright 2007-2011
  ...
  **/
	...
	require_once 'img.lib/Exception.php';
	
	require_once 'img.lib/Image.php';
	require_once 'img.lib/TrueColorImage.php';
	require_once 'img.lib/PaletteImage.php';
	
	require_once 'img.lib/Coordinate.php';
	require_once 'img.lib/Canvas.php';
	require_once 'img.lib/MapperFactory.php';
	require_once 'img.lib/OperationFactory.php';
	
	require_once 'img.lib/Font/TTF.php';
	require_once 'img.lib/Font/GDF.php';
	require_once 'img.lib/Font/PS.php';
